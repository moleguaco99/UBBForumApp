...
import src.UbbForumApp;
import src.config.Constants;
import src.domain.Authority;
import src.domain.User;
import src.repository.AuthorityRepository;
import src.repository.UserRepository;
import src.security.AuthoritiesConstants;
import src.service.MailService;
import src.service.UserService;
import src.service.dto.PasswordChangeDTO;
import src.service.dto.UserDTO;
import src.web.rest.errors.ExceptionTranslator;
import src.web.rest.vm.KeyAndPasswordVM;
 ...
 */
@SpringBootTest(classes = UbbForumApp.class)
